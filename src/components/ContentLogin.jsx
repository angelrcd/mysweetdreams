...
function ContentLogin (){
    ...
    <div className="bg-[url('./img/background.jpg')] h-screen w-full bg-cover flex flex-col justify-start items-center">
        ...
        <FormLogin />
        <div className="bg-blue-800 rounded-2xl py-1 px-6 bg-opacity-50 my-2 text-opacity-100"><p class="text-white">Forgot password? | Don’t have an acoount yet? <a href="" className="underline">Sign up</a></p></div>
    </div>
    );
}
