...
function Description () {
  ...
  <div className="py-16 flex justify-around flex-wrap">
    ...
    <div className="w-36 flex flex-col gap-4 mx-20 mb-10">
      <img className="h-20" src="/icons/world-svgrepo-com.svg" alt="" />
    ...
    <div className="w-36 flex flex-col gap-4 mx-20 mb-10">
      <img className="h-20" src="/icons/shield-svgrepo-com.svg" alt="" />
