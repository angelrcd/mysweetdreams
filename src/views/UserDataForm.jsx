...
function UserDataForm () {
  return (
    <div className="bg-fixed bg-cover bg-[url('/img/background-night.jpg')] flex flex-col items-center">
      ...
      <h2 className="text-shadow-1 text-gray-200 font-quicksand text-3xl font-bold text-center my-6 mx-10">Gracias por registrarte, por favor rellena tus datos para que podamos darte un información mas personalizada</h2>
      <form id="aaa" className='w-fit bg-gray-100 dark:bg-[#1b1b32] opacity-95 rounded-2xl border-2 border-black pt-11 px-16 font-quicksand text-2xl flex flex-col gap-4 mx-5' method="post" action="http://localhost:3000/test/">
      ...
      <div className="bg-white dark:bg-[#1b1b32] rounded-xl py-1 px-6 bg-opacity-95 my-2 text-opacity-100 mb-11 mx-5"><p className="dark:text-white">¿No quieres rellenar tus datos ahora? | <a href="" className="underline">Continuar aquí</a></p></div>
    </div>
  )
}
