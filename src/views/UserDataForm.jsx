...
function UserDataForm () {
  return (
    <div className="bg-fixed bg-cover bg-[url('/img/background-night.jpg')] flex flex-col items-center">
      ...
      <form className='w-fit bg-gray-50 rounded-[40px] border-2 border-black pt-11 px-16 font-quicksand text-2xl flex flex-col gap-4' method="post" action="http://localhost:3000/test/">
        <fieldset className='flex flex-col gap-4'>
        <label htmlFor="name">Nombre<input className='bg-gray-200 w-full rounded-md focus:outline-web-boton focus:shadow-outline py-2 px-5' id="name" name="name" type="text" placeholder="Introduce tu nombre" required /></label>
        <label htmlFor="lastname">Apellidos<input className='bg-gray-200 w-full rounded-md focus:outline-web-boton focus:shadow-outline py-2 px-5' id="lastname" name="lastname" type="text" placeholder="Introduce tus apellidos" required /></label>
        ...
        <fieldset>
          <label htmlFor="profilepicture">Foto de perfil<input className='bg-gray-200 w-full rounded-md focus:outline-web-boton focus:shadow-outline py-2 px-5' id="profilepicture" type="file" name="file" /></label>
        </fieldset>
